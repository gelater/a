module.exports = {
	...
	adminId: "1006912679044206592", //- Replace UserId with the Discord ID of the admin of the bot
	token: process.env.token || "MTI1Nzg4NjAzNDE2Nzg1NzE1Mw.G5cbSY.NvxbxkGFQ1NP00KWkOGJDFubBWphGOvI80m-E8", //- Bot's Token
	clientId: process.env.clientId || "1257886034167857153", //- ID of the bot
	clientSecret: process.env.clientSecret || "J7qXvh85M_jyQsYhZxggpmzFIxBywhrW", //- Client Secret of the bot
